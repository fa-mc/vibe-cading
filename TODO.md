...
- [ ] **Packaging:** Convert the directory structure into an installable pip package (e.g., `pip install .`) so the separate private platform worker can import the classes dynamically.
