<!--
  This file is the Project Harmony Individual Contributor License Agreement
  (HA-CLA-I) v1.0 — a standard, professionally-drafted CLA used by many
  dual-licensed open-source projects — reproduced under its Creative Commons
  Attribution 3.0 license (https://www.harmonyagreements.org/). It is adopted
  here largely as-is; it is NOT bespoke text.

  Selections made for vibe-cading:
    • Outbound License: OPTION FIVE (see §2.3) — lets the project license
      contributions under ANY terms (including commercial/proprietary), while
      committing to ALSO keep them under the project's open-source license
      (AGPLv3) as of the submission date. This is the relicensing grant that
      enables the commercial-license edition, with the "stays-open"
  ...
  fundraise / acquisition.
-->

# vibe-cading Contributor License Agreement

*This is the [Project Harmony](https://www.harmonyagreements.org/) Individual
Contributor License Agreement (HA-CLA-I) v1.0, with Outbound License **Option
Five** selected. Reproduced under [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/).*

---

## Harmony Individual Contributor License Agreement

Thank you for your interest in contributing to vibe-cading ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by
contributors to Us. To make this document effective, please sign it
electronically following the instructions under "How to sign" below. This is a
...
Copyright in the entire work of authorship, please contact the maintainers (by
opening an issue) before Submitting.
...
AGPLv3 (including any right to adopt any future version of a license if
permitted).
...
(d) You have contacted the maintainers, if You do not own the Copyright in the
...
This CLA is checked automatically by the CLA Assistant bot on your first pull
request. When prompted, reply on the PR thread with exactly:

> `I have read the CLA Document and I hereby sign the CLA`

Your electronic signature is recorded in
[`signatures/version2/cla.json`](signatures/version2/cla.json) and satisfies
execution of this Agreement. It covers all of your future Contributions.

---

*This work is licensed under a [Creative Commons Attribution 3.0 Unported
License](https://creativecommons.org/licenses/by/3.0/). Harmony Individual
Contributor License Agreement (HA-CLA-I), Version 1.0, July 4, 2011 — Project
