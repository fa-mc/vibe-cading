...
AXLE_HOLE_TIP_TO_TIP: float = float(os.getenv("AXLE_HOLE_TIP_TO_TIP", "4.61"))  # Axle hole cross tip-to-tip (mm)
AXLE_HOLE_ARM_WIDTH: float = float(os.getenv("AXLE_HOLE_ARM_WIDTH", "1.66"))   # Axle hole flat-to-flat (mm)
