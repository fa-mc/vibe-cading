...
3. `python3 tools/face_catalog.py $1 --summary` then `python3 tools/face_catalog.py $1 --type Cylinder --min-area 5` — surface-type breakdown, then significant cylindrical features.
