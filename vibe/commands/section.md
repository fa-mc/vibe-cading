---
description: Slice a model with vibe_cading/tools/section_slicer.py to verify internal geometry (blind holes, snap rings, counterbores)
...
```
python3 vibe_cading/tools/section_slicer.py $ARGUMENTS
```
