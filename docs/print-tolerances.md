...
| `slip`  | [`Bearing.shaft_cutter`](../vibe_cading/mechanical/bearings.py#L167) | `r = D_inner/2 + profile.slip.radial`                         | D = 5.0 mm | 5.00 + 2·0.05 = **5.10 mm**        |
...
| `press` | [`Bearing.outer_pocket`](../vibe_cading/mechanical/bearings.py#L110) (default `fit=`) | `r = D_outer/2 + profile.press.radial`                        | D = 10.0 mm | 10.00 + 2·0.04 = **10.08 mm**     |
...
| `Bearing.outer_pocket` (chooses grade by `fit=` kwarg, default `"press"`)                      | `press`*| [`bearings.py:110`](../vibe_cading/mechanical/bearings.py#L110)                                  |
| `Bearing.shaft_cutter`                                                                         | `slip`  | [`bearings.py:167`](../vibe_cading/mechanical/bearings.py#L167)                                  |
...
| `Bearing.outer_pocket` (depth clearance; chooses grade by `fit=` kwarg, default `"press"`)     | `press`*| [`bearings.py:111`](../vibe_cading/mechanical/bearings.py#L111)                                  |
